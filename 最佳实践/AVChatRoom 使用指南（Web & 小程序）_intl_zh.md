...
- [初始化（Web & 小程序）](https://intl.cloud.tencent.com/document/product/1047/34314)
- [登录（Web & 小程序）](https://intl.cloud.tencent.com/document/product/1047/34318)
...
1. 登录 [即时通信 IM 控制台](https://console.cloud.tencent.com/im)。
 ...
 >同一个腾讯云账号，最多可创建100个即时通信 IM 应用。若已有100个应用，您可以先 [停用](https://intl.cloud.tencent.com/document/product/1047/34540) 并删除无需使用的应用后再创建新的应用。**应用删除后，该 SDKAppID 对应的所有数据和服务不可恢复，请谨慎操作。**
 >
2. 单击【+添加新应用】。
  ...
  for (let i = 0; i < length; i++) {
    ...
    switch (message.type) {
      ...
      case TIM.TYPES.MSG_GRP_SYS_NOTICE:
        // 收到了群系统通知，通过 REST API 在群组中发送的系统通知请参考 <a href="https://intl.cloud.tencent.com/document/product/1047/34958">在群组中发送系统通知 API</a>
...
_handleGroupSystemNotice(message) {
  ...
  // 用 REST API 发送群系统通知请参考 <a href="https://intl.cloud.tencent.com/document/product/1047/34958">在群组中发送系统通知 API</a>
}
</pre>
...
let message = tim.createTextMessage({
  ...
  // 消息优先级，用于群聊（v2.4.2起支持）。如果某个群的消息超过了频率限制，后台会优先下发高优先级的消息，详细请参考 <a href="https://intl.cloud.tencent.com/document/product/1047/33526">消息优先级与频率控制</a>
