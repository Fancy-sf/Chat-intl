Log in to the [Chat console](https://console.cloud.tencent.com/im), click the target app card, and select **Account Management** in the left sidebar. You can manage accounts according to your business needs.
